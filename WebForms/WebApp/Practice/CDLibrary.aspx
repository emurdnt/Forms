...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server"> 
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="None" runat="server" ErrorMessage="Title is required." ControlToValidate="Title"></asp:RequiredFieldValidator>
        ...
        <asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="Number of tracks must be greater than zero." ControlToValidate="NumberOfTracks" MinimumValue="1" MaximumValue="1000"></asp:RangeValidator>
   </div>
