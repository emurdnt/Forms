...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server"> 
    ...
    <div>
        ...
        <br />
        <asp:Button ID="Button2" runat="server" Text="Add to Library" OnClick ="Button2_Click"/>
        <br />
    </div>
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="None" runat="server" ErrorMessage="Number of tracks is required." ControlToValidate="NumberOfTracks"></asp:RequiredFieldValidator>
         <asp:CompareValidator ID="ValidateNumberOfTracks" runat="server" Display="None"
                    ControlToValidate="NumberOfTracks" 
                    ErrorMessage="Number of tracks must be greater than zero." 
